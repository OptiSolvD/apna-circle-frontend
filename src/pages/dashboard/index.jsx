        ...
        <DashboardLayout>
                ...
                {postState.posts.map((post) => {
                  return (
                    <div key={post._id} className={styles.singleCard}>
                      <div className={styles.sigleCard_profileContainer}>
                        <div>
                          <div
                            style={{
                              display: "flex",
                          ...
                          >
                            <div
                              className={
                                styles.singleCard_profileContainer_header
                              }
                              style={{ display: "flex", gap: "1rem" }}
                            >
                              <img
                                className={
                                  styles.singleCard_profileContainer_userProfile
                                }
                                src={`${BASE_URL}/${authState.user.userId.profilePicture}`}
                                alt=""
                              />
                          ...
                          <div className={styles.optionsContainer}>
                            <div
                              ...
                              className={styles.sigleOption_optionsContainer}
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                            ...
                            <div
                              onClick={() => {
                                ...
                                const url =
                                  encodeURIComponent("apnaciecle.com");
          ...
          {postState.postId !== "" && (
            ...
            >
              ...
              >
                {postState.comments.length=== 0 && <h2 style={{color:"red"}}>No Comments</h2>}
